...
0000000000401000 <_start>:
  ...
  401007:	00 00 00 
  40100a:	e8 30 01 00 00       	callq  40113f <printString>

000000000040100f <ever_loop>:
  40100f:	48 bf 4b 20 40 00 00 	movabs $0x40204b,%rdi
  401016:	00 00 00 
  401019:	e8 f8 00 00 00       	callq  401116 <open_file>
  ...
  40104d:	e8 d7 00 00 00       	callq  401129 <read_file>
...
000000000040109b <delete_and_try>:
  ...
  4010a2:	00 
  4010a3:	e8 5e 00 00 00       	callq  401106 <close_file>
  4010a8:	48 bf 4b 20 40 00 00 	movabs $0x40204b,%rdi
  4010af:	00 00 00 
  4010b2:	e8 57 00 00 00       	callq  40110e <delete_file>
  4010b7:	e9 53 ff ff ff       	jmpq   40100f <ever_loop>

00000000004010bc <close_and_try>:
  4010bc:	48 8b 3c 25 55 20 40 	mov    0x402055,%rdi
  4010c3:	00 
  4010c4:	e8 3d 00 00 00       	callq  401106 <close_file>
  4010c9:	e9 41 ff ff ff       	jmpq   40100f <ever_loop>

00000000004010ce <after_ever_loop>:
  4010ce:	48 be 00 20 40 00 00 	movabs $0x402000,%rsi
  4010d5:	00 00 00 
  4010d8:	e8 62 00 00 00       	callq  40113f <printString>
  4010dd:	48 be 1f 20 40 00 00 	movabs $0x40201f,%rsi
  4010e4:	00 00 00 
  4010e7:	e8 53 00 00 00       	callq  40113f <printString>
  4010ec:	eb 0f                	jmp    4010fd <exit>

00000000004010ee <error>:
  4010ee:	48 be 44 20 40 00 00 	movabs $0x402044,%rsi
  4010f5:	00 00 00 
  4010f8:	e8 42 00 00 00       	callq  40113f <printString>
...
000000000040113f <printString>:
  ...
  401147:	e8 12 00 00 00       	callq  40115e <GetStrlen>
